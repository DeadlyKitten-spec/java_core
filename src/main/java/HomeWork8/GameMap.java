...
public class GameMap extends JPanel {
    ...
    private static final int DOT_FIRST_HUMAN = 3;
    private static final int DOT_SECOND_HUMAN = 4;
    private static final int DOT_EMPTY = 0;
    private static final int DOT_PADDING = 7;
    private static final int STATE_DRAW = 0;
    private static final int STATE_WIN_HUMAN = 1;
    private static final int STATE_WIN_AI = 2;
    private static final int STATE_WIN_FIRST_HUMAN = 3;
    private static final int STATE_WIN_SECOND_HUMAN = 4;
    ...
    private void update(MouseEvent e, int playerNumTurn) {
        ...
        if (gameMode == 0) {
            ...
            if (playerNumTurn == 1) {
                if (!playerTurn(e, DOT_FIRST_HUMAN)) {
                    return;
                }
                if (gameCheck(DOT_FIRST_HUMAN, STATE_WIN_FIRST_HUMAN)) {
                    return;
                }
                this.playerNumTurn = 2;
            } else {
                if (!playerTurn(e, DOT_SECOND_HUMAN)) {
                    return;
                }
                if (gameCheck(DOT_SECOND_HUMAN, STATE_WIN_SECOND_HUMAN)) {
                    return;
                }
    ...
    private void render(Graphics g) {
        ...
        for (int y = 0; y < fieldSizeY; y++) {
            for (int x = 0; x < fieldSizeX; x++) {
                ...
                if (field[y][x] == DOT_HUMAN || field[y][x] == DOT_FIRST_HUMAN) {
    ...
    private void showGameOverMessage(Graphics g) {
        ...
        switch (stateGameOver) {
            ...
            case STATE_WIN_AI:
                ...
                break;
            case STATE_WIN_FIRST_HUMAN:
                g.drawString("FIRST HUMAN WIN", getWidth() / 4, getHeight() / 2);
                break;
            case STATE_WIN_SECOND_HUMAN:
                g.drawString("SECOND HUMAN WIN", getWidth() / 4, getHeight() / 2);
                break;
        }
    }
